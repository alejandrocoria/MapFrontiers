...
public class GuiVertexShapeButtons extends AbstractWidget {
    ...
    public GuiVertexShapeButtons(Font font, int x, int y, int selected, Consumer<GuiVertexShapeButtons> callbackShapeUpdated) {
        super(x, y, 324, 120, CommonComponents.EMPTY);
        this.selected = selected;
        labelShapes = new GuiSimpleLabel(font, x + 162, y, GuiSimpleLabel.Align.Center, Component.translatable("mapfrontiers.initial_shape"), GuiColors.WHITE);
        labelVertices = new GuiSimpleLabel(font, x + 162, y + 126, GuiSimpleLabel.Align.Center, Component.literal(""), GuiColors.WHITE);
