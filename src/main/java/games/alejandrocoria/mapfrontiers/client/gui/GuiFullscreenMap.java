...
public class GuiFullscreenMap {
    ...
    public boolean mapClicked(RegistryKey<World> dimension, BlockPos position, int button) {
    ...
    public boolean mapDragged(RegistryKey<World> dimension, BlockPos position) {
        if (!editing) {
            return false;
        }
    ...
    public void mouseMoved(RegistryKey<World> dimension, BlockPos position) {
