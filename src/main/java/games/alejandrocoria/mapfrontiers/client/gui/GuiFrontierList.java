...
public class GuiFrontierList extends Screen implements GuiScrollBox.ScrollBoxResponder {
    ...
    public void init() {
        ...
        Component title = Component.translatable("mapfrontiers.title_frontiers");
        ...
        addRenderableOnly(new GuiSimpleLabel(font, actualWidth / 2 + 170, 214, GuiSimpleLabel.Align.Left,
