...
public class GuiFrontierInfo extends Screen implements TextIntBox.TextIntBoxResponder, TextBox.TextBoxResponder {
    ...
    private boolean needUpdatePasteOptionsVisibility = false;
    ...
    public void tick() {
        ...
        if (needUpdatePasteOptionsVisibility) {
            needUpdatePasteOptionsVisibility = false;
            updatePasteOptionsVisibility();
        }
    }
    ...
    protected void buttonPressed(Button button) {
        if (button == buttonVisible) {
            ...
            needUpdatePasteOptionsVisibility = true;
