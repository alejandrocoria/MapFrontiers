...
public class GuiFrontierInfo extends Screen implements TextIntBox.TextIntBoxResponder, TextBox.TextBoxResponder {
    ...
    public void init() {
        ...
        addRenderableOnly(new GuiSimpleLabel(font, leftSide, top + 70, GuiSimpleLabel.Align.Left,
                new TranslatableComponent("mapfrontiers.show_frontier"), GuiColors.SETTINGS_TEXT));
        buttonVisible = new GuiOptionButton(font, leftSide + 116, top + 68, 28, this::buttonPressed);
        buttonVisible.addOption(new TranslatableComponent("options.on"));
        buttonVisible.addOption(new TranslatableComponent("options.off"));
        ...
        addRenderableOnly(new GuiSimpleLabel(font, rightSide, top + 70, GuiSimpleLabel.Align.Left,
                new TranslatableComponent("mapfrontiers.show_fullscreen"), GuiColors.SETTINGS_TEXT));
        buttonFullscreenVisible = new GuiOptionButton(font, rightSide + 116, top + 68, 28, this::buttonPressed);
        buttonFullscreenVisible.addOption(new TranslatableComponent("options.on"));
        buttonFullscreenVisible.addOption(new TranslatableComponent("options.off"));
        ...
        buttonFullscreenNameVisible.addOption(new TranslatableComponent("options.on"));
        buttonFullscreenNameVisible.addOption(new TranslatableComponent("options.off"));
        ...
        buttonFullscreenOwnerVisible.addOption(new TranslatableComponent("options.on"));
        buttonFullscreenOwnerVisible.addOption(new TranslatableComponent("options.off"));
        ...
        addRenderableOnly(new GuiSimpleLabel(font, rightSide + 154, top + 70, GuiSimpleLabel.Align.Left,
                new TranslatableComponent("mapfrontiers.show_minimap"), GuiColors.SETTINGS_TEXT));
        buttonMinimapVisible = new GuiOptionButton(font, rightSide + 154 + 116, top + 68, 28, this::buttonPressed);
        buttonMinimapVisible.addOption(new TranslatableComponent("options.on"));
        buttonMinimapVisible.addOption(new TranslatableComponent("options.off"));
        ...
        buttonMinimapNameVisible.addOption(new TranslatableComponent("options.on"));
        buttonMinimapNameVisible.addOption(new TranslatableComponent("options.off"));
        ...
        buttonMinimapOwnerVisible.addOption(new TranslatableComponent("options.on"));
        buttonMinimapOwnerVisible.addOption(new TranslatableComponent("options.off"));
        ...
        addRenderableOnly(new GuiSimpleLabel(font, leftSide, top + 102, GuiSimpleLabel.Align.Left,
                new TranslatableComponent("mapfrontiers.announce_in_title"), GuiColors.SETTINGS_TEXT));
        buttonAnnounceInTitle = new GuiOptionButton(font, leftSide + 116, top + 100, 28, this::buttonPressed);
        buttonAnnounceInTitle.addOption(new TranslatableComponent("options.on"));
        buttonAnnounceInTitle.addOption(new TranslatableComponent("options.off"));
        ...
        labelPasteName = new GuiSimpleLabel(font, rightSide + 154, top + 200, GuiSimpleLabel.Align.Left,
                new TranslatableComponent("mapfrontiers.paste_name"), GuiColors.SETTINGS_TEXT);
        addRenderableOnly(labelPasteName);
        buttonPasteName = new GuiOptionButton(font, rightSide + 154 + 116, top + 198, 28, this::buttonPressed);
        buttonPasteName.addOption(new TranslatableComponent("options.on"));
        buttonPasteName.addOption(new TranslatableComponent("options.off"));
        ...
        labelPasteVisibililty = new GuiSimpleLabel(font, rightSide + 154, top + 216, GuiSimpleLabel.Align.Left,
                new TranslatableComponent("mapfrontiers.paste_visibility"), GuiColors.SETTINGS_TEXT);
        addRenderableOnly(labelPasteVisibililty);
        buttonPasteVisibililty = new GuiOptionButton(font, rightSide + 154 + 116, top + 214, 28, this::buttonPressed);
        buttonPasteVisibililty.addOption(new TranslatableComponent("options.on"));
        buttonPasteVisibililty.addOption(new TranslatableComponent("options.off"));
        ...
        labelPasteColor = new GuiSimpleLabel(font, rightSide + 154, top + 232, GuiSimpleLabel.Align.Left,
                new TranslatableComponent("mapfrontiers.paste_color"), GuiColors.SETTINGS_TEXT);
        addRenderableOnly(labelPasteColor);
        buttonPasteColor = new GuiOptionButton(font, rightSide + 154 + 116, top + 230, 28, this::buttonPressed);
        buttonPasteColor.addOption(new TranslatableComponent("options.on"));
        buttonPasteColor.addOption(new TranslatableComponent("options.off"));
        ...
        labelPasteBanner = new GuiSimpleLabel(font, rightSide + 154, top + 248, GuiSimpleLabel.Align.Left,
                new TranslatableComponent("mapfrontiers.paste_banner"), GuiColors.SETTINGS_TEXT);
        addRenderableOnly(labelPasteBanner);
        buttonPasteBanner = new GuiOptionButton(font, rightSide + 154 + 116, top + 246, 28, this::buttonPressed);
        buttonPasteBanner.addOption(new TranslatableComponent("options.on"));
        buttonPasteBanner.addOption(new TranslatableComponent("options.off"));
    ...
    public void render(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (buttonBanner.visible && buttonBanner.isHoveredOrFocused()) {
            ...
            renderTooltip(matrixStack, new TranslatableComponent("mapfrontiers.copy"), mouseX, mouseY);
        } else if (buttonPaste.visible && buttonPaste.isHoveredOrFocused()) {
            renderTooltip(matrixStack, new TranslatableComponent("mapfrontiers.paste"), mouseX, mouseY);
        } else if (buttonOpenPasteOptions.visible && buttonOpenPasteOptions.isHoveredOrFocused()) {
            renderTooltip(matrixStack, new TranslatableComponent("mapfrontiers.open_paste_options"), mouseX, mouseY);
        } else if (buttonClosePasteOptions.visible && buttonClosePasteOptions.isHoveredOrFocused()) {
            renderTooltip(matrixStack, new TranslatableComponent("mapfrontiers.close_paste_options"), mouseX, mouseY);
        } else if (buttonUndo.visible && buttonUndo.isHoveredOrFocused()) {
            renderTooltip(matrixStack, new TranslatableComponent("mapfrontiers.undo"), mouseX, mouseY);
        } else if (buttonRedo.visible && buttonRedo.isHoveredOrFocused()) {
            renderTooltip(matrixStack, new TranslatableComponent("mapfrontiers.redo"), mouseX, mouseY);
        }
