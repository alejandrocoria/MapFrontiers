...
public class GuiNewFrontier extends Screen implements TextIntBox.TextIntBoxResponder {
    ...
    public void init() {
        ...
        buttons.add(new GuiSimpleLabel(font, actualWidth / 2 - 130, actualHeight / 2 - 112, GuiSimpleLabel.Align.Left,
        ...
        buttons.add(new GuiSimpleLabel(font, actualWidth / 2 - 130, actualHeight / 2 - 96, GuiSimpleLabel.Align.Left,
                new TranslationTextComponent("mapfrontiers.frontier_mode"), GuiColors.SETTINGS_TEXT));
        ...
        buttons.add(new GuiSimpleLabel(font, actualWidth / 2 - 130, actualHeight / 2 - 80, GuiSimpleLabel.Align.Left,
        ...
        labelSize = new GuiSimpleLabel(font, actualWidth / 2 - 80, actualHeight / 2 + 90, GuiSimpleLabel.Align.Left, new StringTextComponent(""), GuiColors.WHITE);
        ...
        addButton(buttonFrontierMode);
        addButton(buttonAfterCreate);
        addButton(vertexShapeButtons);
        addButton(chunkShapeButtons);
        addButton(textSize);
    ...
    private void shapeButtonsUpdated() {
        if (ConfigData.newFrontierMode == FrontierData.Mode.Vertex) {
            ...
            if (chunkShapeButtons.getShapeMeasure() == GuiChunkShapeButtons.ShapeMeasure.Width) {
                ...
                labelSize.setText(new TranslationTextComponent("mapfrontiers.shape_length"));
    ...
    private List<BlockPos> calculateVertices() {
        ...
        List<Vector3d> shapeVertices = vertexShapeButtons.getVertices();
