...
public class GuiHUD {
    ...
    public GuiHUD(FrontiersOverlayManager frontiersOverlayManager, FrontiersOverlayManager personalFrontiersOverlayManager) {
        ...
        slots = new ArrayList<>();
        frontierName1 = new GuiSimpleLabel(mc.font, 0, 0, GuiSimpleLabel.Align.Center, CommonComponents.EMPTY,
                GuiColors.WHITE);
        frontierName2 = new GuiSimpleLabel(mc.font, 0, 0, GuiSimpleLabel.Align.Center, CommonComponents.EMPTY,
                GuiColors.WHITE);
        frontierOwner = new GuiSimpleLabel(mc.font, 0, 0, GuiSimpleLabel.Align.Center, CommonComponents.EMPTY,
                GuiColors.WHITE);
    ...
    public void RenderGameOverlayEvent(RenderGuiOverlayEvent.Pre event) {
        ...
        if (event.getOverlay().id().equals(VanillaGuiOverlay.POTION_ICONS.id())) {
            ...
            draw(event.getPoseStack(), event.getWindow(), event.getPartialTick());
        }
    }
