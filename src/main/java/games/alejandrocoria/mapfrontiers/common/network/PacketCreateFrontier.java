...
public class PacketCreateFrontier {
    ...
    public PacketCreateFrontier(RegistryKey<World> dimension, boolean personal, @Nullable List<BlockPos> vertices, @Nullable List<ChunkPos> chunks) {
    ...
    public static PacketCreateFrontier fromBytes(PacketBuffer buf) {
    ...
    public static void toBytes(PacketCreateFrontier packet, PacketBuffer buf) {
    ...
    public static void handle(PacketCreateFrontier message, Supplier<NetworkEvent.Context> ctx) {
