...
public class PacketHandler {
    public static void init() {
        // server to client
        CommonNetworkMod.registerPacket(PacketPlayerNameMappings.type(), PacketPlayerNameMappings.class, PacketPlayerNameMappings.STREAM_CODEC, PacketPlayerNameMappings::handle);
        ...
        CommonNetworkMod.registerPacket(PacketUpdateFrontierSettings.type(), PacketUpdateFrontierSettings.class, PacketUpdateFrontierSettings.STREAM_CODEC, PacketUpdateFrontierSettings::handle);
    ...
    public static <MSG> void sendToUsersWithAccessExcept(MSG message, FrontierData frontier,
