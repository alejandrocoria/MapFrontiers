...
public class PacketHandler {
    public static void init() {
        // server to client
        Network.registerPacket(PacketPlayerNameMappings.CHANNEL, PacketPlayerNameMappings.class, PacketPlayerNameMappings::encode, PacketPlayerNameMappings::new, PacketPlayerNameMappings::handle);
