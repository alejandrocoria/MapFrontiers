...
public class FrontierListElement extends ScrollBox.ScrollElement {
    ...
    protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks, boolean selected, boolean focused) {
        ...
        graphics.drawString(font, owner, x + METADATA_X + OWNER_X_OFFSET + offset1, y + 4, color);
    ...
    private void drawModeBadge(GuiGraphics graphics, boolean selected) {
        ...
        graphics.drawString(font, countText, countX, y + MODE_BADGE_COUNT_Y, ColorConstants.TEXT_DIMENSION);
    }
