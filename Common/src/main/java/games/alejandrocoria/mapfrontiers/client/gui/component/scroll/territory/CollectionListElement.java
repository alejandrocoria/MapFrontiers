...
public class CollectionListElement extends TerritoryListRowElement implements ScrollBox.KeyedFocusNavigation {
    ...
    protected void drawFocusOutline(GuiGraphics graphics) {
        ...
        int left = x + 2;
        int top = y + 2;
        graphics.submitOutline(left, top, width - 4, height - 2, ColorConstants.COLLECTION_LIST_ROW_OUTLINE);
    }
    ...
    private void renderMarkedCount(GuiGraphics graphics) {
        ...
        graphics.submitOutline(badgeLeft, badgeTop, badgeWidth, MARKED_BADGE_HEIGHT, ColorConstants.MARKED_BADGE_OUTLINE);
