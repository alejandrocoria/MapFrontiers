...
public class ColorPicker extends AbstractWidgetNoNarration {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (randomButton.mouseClicked(mouseX, mouseY, button)) {
            focusedPart = FocusPart.RANDOM;
            return true;
        }
    ...
    public void onRelease(double mouseX, double mouseY) {
        randomButton.onRelease(mouseX, mouseY);
    ...
    private void updateKeyboardMovement() {
        ...
        boolean leftPressed = InputConstants.isKeyDown(windowHandle, org.lwjgl.glfw.GLFW.GLFW_KEY_LEFT);
        boolean rightPressed = InputConstants.isKeyDown(windowHandle, org.lwjgl.glfw.GLFW.GLFW_KEY_RIGHT);
        boolean upPressed = InputConstants.isKeyDown(windowHandle, org.lwjgl.glfw.GLFW.GLFW_KEY_UP);
        boolean downPressed = InputConstants.isKeyDown(windowHandle, org.lwjgl.glfw.GLFW.GLFW_KEY_DOWN);
    ...
    private void renderHsBackground(GuiGraphics graphics) {
        ...
        GuiGraphicsHelper.blitTranslucent(graphics, TEXTURE, getX(), getY(), backgroundU, backgroundV,
                HS_SIZE, HS_SIZE, TEXTURE_WIDTH, TEXTURE_HEIGHT);
    }

    private void renderVBackground(GuiGraphics graphics) {
        GuiGraphicsHelper.blitTinted(graphics, TEXTURE, getX() + V_X, getY(), V_BACKGROUND_U, V_BACKGROUND_V,
                V_WIDTH, V_HEIGHT, TEXTURE_WIDTH, TEXTURE_HEIGHT,
                active ? colorFullBrightness : ColorConstants.COLOR_PICKER_VALUE_DISABLED_TINT);
        GuiGraphicsHelper.blitTinted(graphics, TEXTURE, getX() + V_X, getY(), V_BORDER_U, V_BORDER_V,
    ...
    private void renderSelectedMarkers(GuiGraphics graphics) {
        ...
        GuiGraphicsHelper.blitTranslucent(graphics, TEXTURE, getX() + (int) hsX + HS_CENTER - HS_SELECTION_OFFSET,
        ...
        GuiGraphicsHelper.blitTranslucent(graphics, TEXTURE, getX() + V_SELECTION_X, getY() + (int) v - V_MARKER_OFFSET_Y,
                vSelectionU, vSelectionV, V_SELECTION_WIDTH, V_SELECTION_HEIGHT, TEXTURE_WIDTH, TEXTURE_HEIGHT);
    }

    private void renderFocusedMarkers(GuiGraphics graphics) {
        ...
        if (focusedPart == FocusPart.HS) {
            GuiGraphicsHelper.blitTranslucent(graphics, TEXTURE,
        ...
        GuiGraphicsHelper.blitTranslucent(graphics, TEXTURE, getX() + V_SELECTION_X,
