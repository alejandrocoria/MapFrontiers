...
public class HUD {
    ...
    private interface PreparedSlot {
        int getHeight();
        void render(GuiGraphicsExtractor graphics, int frameColor, int textNameColor, int textOwnerColor, float partialTicks);
    }
    ...
    private class TextPreparedSlot implements PreparedSlot {
        ...
        @Override
        public void render(GuiGraphicsExtractor graphics, int frameColor, int textNameColor, int textOwnerColor, float partialTicks) {
            ...
            for (StringWidget widget : widgets) {
                ...
                widget.extractRenderState(graphics, 0, 0, partialTicks);
            }
        }
    }
