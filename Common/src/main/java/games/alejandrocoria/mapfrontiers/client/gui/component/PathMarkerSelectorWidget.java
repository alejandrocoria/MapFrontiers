...
public class PathMarkerSelectorWidget extends AbstractWidgetNoNarration {
    ...
    private Consumer<ResourceLocation> onPress;
    private ResourceLocation selectedId;
    private int focusedIndex;

    public PathMarkerSelectorWidget(ResourceLocation selectedId, Consumer<ResourceLocation> onPress) {
    ...
    public void setOnPress(Consumer<ResourceLocation> onPress) {
        this.onPress = onPress;
    }
    ...
    public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        for (int i = 0; i < PathMarkerCatalog.BUILT_INS.size(); ++i) {
            ...
            if (isKeyboardFocused() && focusedIndex == i) {
                graphics.submitOutline(x - 1, getY() - 1, CELL_SIZE + 2, CELL_SIZE + 2, ColorConstants.PATH_MARKER_SELECTOR_FOCUS_OUTLINE);
            }
