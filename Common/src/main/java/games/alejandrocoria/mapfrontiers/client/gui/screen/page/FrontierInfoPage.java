...
public class FrontierInfoPage extends PageScreen {
    ...
    private void buildOverviewSection(GridLayout mainLayout) {
        ...
        Component dimension = Component.translatable(DIMENSION_KEY, frontier.getDimension().location().toString());
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == GLFW.GLFW_KEY_Z && Screen.hasControlDown() && !Screen.hasShiftDown() && !Screen.hasAltDown()) {
            undo();
            return true;
