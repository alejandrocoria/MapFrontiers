...
final class PathMarkerOverlayLayer {
    ...
    private void updateVisual(VisualReference visual, ResourceLocation markerId, float rotation,
    ...
    private static final class VisualReference {
        ...
        private void update(ResourceLocation texture, int tint, float opacity, int markerSize, int rotation) {
            if (key == null
    ...
    private static final class UiBucket {
        ...
        private void addOverlays(List<MarkerOverlay> overlays) {
            ...
            if (!pointBuckets.isEmpty()) {
                pointBuckets.get(pointBuckets.size() - 1).addOverlay(overlays);
            }
        }
    }
