...
final class OverlayTestStates {
    private static final ResourceKey<Level> TEST_DIMENSION = createTestDimension();
    ...
    private static ResourceKey<Level> createTestDimension() {
        try {
            ...
            return (ResourceKey<Level>) create.invoke(null, new ResourceLocation("minecraft", "dimension"),
                    new ResourceLocation("mapfrontiers", "test_dimension"));
    ...
    static MarkerOverlayState marker(int x, String visualKey) {
        MapImage icon = new MapImage(new ResourceLocation("mapfrontiers", "textures/test/" + visualKey + ".png"), 16, 16);
